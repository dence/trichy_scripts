...
def update_no_gould(no_gould,line):
	...
	if(re.search("Pentatrich_hominis.new",line)):
		no_gould["Pentatrich"] = 1
	if(re.search("Trich.tenax.new",line)):
		no_gould["tenax"] = 1
	if(re.search("Tritrich.foetus.new",line)):
		no_gould["foetus"] = 1
...
def update_gould(with_gould, line):
	...
	if(re.search("foetus",line)):
		with_gould["foetus"] = 1
	if(re.search("Trich_gall",line)):
		with_gould["Trich_gall"] = 1
	if(re.search("Trichomitus_batr",line)):
		with_gould["Trichomitus_batr"] = 1
#	if(re.search("Tvag.30235",line)):
#		with_gould["3025"] = 1
#	if(re.search("Tvag.30238",line)):
#		with_gould["30238"] = 1
...
for report in blast_reports:
	...
	target_common_set_gould = {'Pentatrich':0,'Tetratrich':0,'tenax':0,'foetus':0,'Trich_gall':0,'Trichomitus_batr':0,"Tvag":0}
